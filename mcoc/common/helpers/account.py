...
def build_profile_display(parent: Any, ctx_or_author: Any, target_id: int, viewer_id: Optional[int] = None, *, prefer_embed: bool = True) -> Tuple[Optional[Any], Optional[str]]:
    ...
    try:
        ...
        try:
            ...
            emb.add_field(name="MCOC Username", value=str(mcoc_id) if mcoc_id else "Not linked", inline=True)
            ...
            if started:
                emb.add_field(name="Playing Since", value=_format_playing_since(started), inline=True)
